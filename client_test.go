...
func (c *shutdownCodec) WriteHeaderBody(*Header, interface{}) error { return nil }
func (c *shutdownCodec) ReadBody(interface{}) error                 { return nil }
func (c *shutdownCodec) ReadHeader(*Header) error {
	c.responded <- 1
	return errors.New("shutdownCodec RecvHeader")
}
